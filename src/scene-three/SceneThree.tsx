...
const MyChild: FC = () => {
  ...
  terrainMaterial.mixTexture = new Texture("/textures/mixMap_test.png", scene!);
  ...
  terrainMaterial.bumpTexture1 = new Texture(
...
const SceneThree: FC = () => {
  ...
  const setHavok = (e: SceneEventArgs) => {
    ...
    // SceneLoader.LoadAssetContainer("/textures/","x-bot.glb",scene,(container)=>{
    //   setAC(container);
    //   const [mesheRoot] = container.meshes;
    //   container.addAllToScene();
    //   const character = new ThirdPersonController(container,camera,scene);
        ...
        {HK ? (
          <Scene onSceneMount={setHavok}>
            ...
            <sphere
              ...
              diameter={2}
              segments={32}
              position={new Vector3(5, 4, 36)}
            >
              <physicsAggregate
                type={PhysicsShapeType.SPHERE}
                _options={{ mass: 1, restitution: 0.75 }}
              />
            </sphere>
