...
import ValleyVillageScene from "../scenes/ValleyVillageScene";
...
class Application {
  ...
  private _valleyVillageScreen: ValleyVillageScene | null;
  ...
  *appStateMachine() {
  ...
  private initialize() {
    ...
    this._inputManager = new GameInputManager(
      this._engine,
      InputActionsMap.inputControlsMap
    );
  ...
  private goToRunningState() {
    ...
    //   this._engine.hideLoadingUI();
    // })
    this._valleyVillageScreen = new ValleyVillageScene(
      this._engine,
      new GameInputManager(this._engine, characterControls.characterControlsMap)
    );
    this._valleyVillageScreen?.scene.onReadyObservable.add(() => {
      this._engine.hideLoadingUI();
    });
    this._currentScene = this._valleyVillageScreen;
